...
const rows = [
    createData('08ALAV101', 0, 'RG08', 'papel'),
    createData('08ALAV102', 0, 'RG08', 'papel'),
    createData('08ALAV201', 0, 'RG08', 'papel'),
    createData('08ALAV202', 0, 'RG08', 'papel'),
    createData('08ALDEV01', 0, 'RG08', 'papel'),
    createData('08ALEXP01', 0, 'RG08', 'papel'),
    createData('08ALJEF01', 0, 'RG08', 'papel'),
]

//Funcion donde se definie la tabla con stickyhead
export const TablaAlbacete = () => {
